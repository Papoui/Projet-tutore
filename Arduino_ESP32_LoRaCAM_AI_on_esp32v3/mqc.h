...
/* adapted to the Arduino image sensor board by Congduc Pham, University of Pau, 2015 */

typedef struct in_img_struct {
...
#ifdef LORA_UCAM
#define MQC_NUMCTXS 260
#else
#define MQC_NUMCTXS 100
#endif
